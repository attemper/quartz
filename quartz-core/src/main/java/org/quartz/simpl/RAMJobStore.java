...
public class RAMJobStore implements JobStore {
    ...
    @Override
    public List<OperableTrigger> getTriggersForCalendar(String calName) throws JobPersistenceException {
        ArrayList<OperableTrigger> trigList = new ArrayList<OperableTrigger>();

        synchronized (lock) {
            for (TriggerWrapper tw : getTriggerWrappersForCalendar(calName)) {
                OperableTrigger trig = tw.getTrigger();
                trigList.add(trig);
            }
        }
